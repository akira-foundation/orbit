-- +goose Up
ALTER TABLE projects ADD COLUMN python_version TEXT NOT NULL DEFAULT '';
...
CREATE TABLE projects_new (
    ...
    runtime_kind       TEXT    NOT NULL DEFAULT 'command',
...
SELECT id, name, path, slug, local_domain, detected_framework, package_manager,
       dev_command, dev_port, status, secure, installed_hash, node_version,
       runtime_kind, php_version, created_at, updated_at FROM projects;
DROP TABLE projects;
