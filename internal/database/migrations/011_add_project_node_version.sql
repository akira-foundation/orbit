-- +goose Up
ALTER TABLE projects ADD COLUMN node_version TEXT NOT NULL DEFAULT '';
...
SELECT id, name, path, slug, local_domain, detected_framework, package_manager,
       dev_command, dev_port, status, secure, installed_hash, created_at, updated_at FROM projects;
DROP TABLE projects;
